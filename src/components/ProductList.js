...
function ProductList() {
    ...
    const  updateProduct= () =>{
        axios.get("https://product-api-001.herokuapp.com/api/products").then((response)=>{   //เอาค่าทำได้จาก URL ไปใส่ใน setProduct
    ...
    const deleteProduct = (product) =>{
        swal({
          ...
          .then((willDelete) => {
            if (willDelete) {
                axios.delete("https://product-api-001.herokuapp.com/api/products/"+product._id).then(
                    (response)=>{
